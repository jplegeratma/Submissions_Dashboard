...
SELECT t.RUN_DATE, t.DOS_MON, t.CLAIM_MCE, t.CDE_ENTITY_MODEL, t.ENTITY_PIDSL, t.ENTITY_NAME, t.REC_COUNT, a.AVG_RECS, a.SD_RECS,
t.REC_COUNT/(a.AVG_RECS) AS PCT_RECS
FROM (
SELECT RUN_DATE, DOS_MON, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME,
    SUM(RECORD_COUNT) AS REC_COUNT
FROM INF_B_SUB_DASH_WH_DOS_ACO_COUNTS
GROUP BY RUN_DATE, DOS_MON, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME
) AS t
...
AS
SELECT RUN_DATE, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME, AVG(RECORD_COUNT) AVG_RECS, STDDEV (RECORD_COUNT) SD_RECS
FROM (
SELECT RUN_DATE, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME, DOS_MON,
    SUM(RECORD_COUNT) AS RECORD_COUNT
FROM INF_B_SUB_DASH_WH_DOS_ACO_COUNTS
GROUP BY RUN_DATE, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME, DOS_MON
ORDER BY RUN_DATE, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME, DOS_MON
)
GROUP BY RUN_DATE, CLAIM_MCE, CDE_ENTITY_MODEL, ENTITY_PIDSL, ENTITY_NAME
